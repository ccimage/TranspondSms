...
public class Define {
    ...
    public static String SP_MSG_LAST_KEY = "tsms_msg_last_key";
    ...
    public static String SP_MSG_SEND_UTIL_WECHAT_CORP_ID = "tsms_msg_send_util_wechat_1";
    public static String SP_MSG_SEND_UTIL_WECHAT_SECRET = "tsms_msg_send_util_wechat_2";
    public static String SP_MSG_SEND_UTIL_WECHAT_TAG_ID = "tsms_msg_send_util_wechat_3";
    public static String SP_MSG_SEND_UTIL_WECHAT_AGENT_ID = "tsms_msg_send_util_wechat_4";
}
